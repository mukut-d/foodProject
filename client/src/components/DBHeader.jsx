    ...
    "
      >
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <motion.div
            {...buttonClick}
            className="w-10 h-10 rounded-md cursor-pointer bg-rose-50 backdrop-blur-md shadow-md flex items-center justify-center"
          >
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <motion.div
              onClick={signOut}
              {...buttonClick}
              className="w-10 h-10 rounded-md cursor-pointer bg-rose-50 shadow-md flex items-center justify-center"
            >
