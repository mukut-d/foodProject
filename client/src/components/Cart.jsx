...
const Cart = () => {
  ...
  return (
    <>
      <motion.div
        {...slideIn}
        className="fixed z-50 top-0 right-0 w-380 md:w-600 bg-lightOverlay backdrop-blur-md shadow-md h-screen"
      >
        <div className="w-full flex items-center justify-between py-4 pb-12 px-4">
          <motion.i
